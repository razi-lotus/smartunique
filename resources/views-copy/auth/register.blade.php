            ...
            <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        ...
                        <select name="country_id" required class="select-country form-control @error('country_id') is-invalid @enderror" value="{{ old('country_id') }}" id="yourEmail" >
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        ...
                        <select name="city_id" required class="cities-select form-control @error('city_id') is-invalid @enderror" value="{{ old('city_id') }}" id="yourEmail" >
                            <option value="85572">select city</option>
                        </select>
                        @error('city_id')
                            <div class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
